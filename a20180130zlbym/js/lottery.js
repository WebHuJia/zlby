...
* @Last Modified time: 2017-10-10 18:33:22
*/
    ...
    var faceInit = (function(){
        ...
        if(config.r){//调整坐标位置
            startBtn.onload = function(){
                startBtn.style.cssText = 'margin-left:' + -(startBtn.width / 2 + config.sx)*1.8/100 + 'rem; margin-top:' + -(startBtn.height / 2 + config.sy)*1.8/100 + 'rem';
